...
export const FormInput = ({ type, ...props }: FormInputProps) => {
	...
	return (
		<div className="form-input flex w-full items-center rounded border-zinc-300 bg-transparent p-0 text-dark-he placeholder:text-dark-le focus-within:border-primary-500 focus-within:outline-none focus-within:ring-1 focus-within:ring-primary-500 dark:border-zinc-600 dark:text-light-he dark:placeholder:text-light-le focus-within:dark:border-primary-400 focus-within:dark:ring-primary-400">
